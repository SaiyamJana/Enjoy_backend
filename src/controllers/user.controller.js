...
const loginUser = asyncHandler(async(req , res) => {
    ...
    //find the user in database using email or username
    ...
    //send cookie with refresh token to frontend
...
const logoutUser = asyncHandler(async(req , res) => {
    //get user id from req.user (after auth middleware)
    //find the user in database
    //if user not found -> throw error
    //if user found -> remove refresh token from database
    //clear cookies in frontend

    //due to middleware the user will be available in req.user
...
//if session expired , refresh token will be used to generate new access token and refresh token
